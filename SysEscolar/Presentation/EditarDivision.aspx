<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarDivision.aspx.cs" Inherits="SysEscolar.Presentation.EditarDivision" %>
            ...
            <div class="row justify-content-center align-items-center min-vh-100">
                <div class="col-12 col-sm-10 col-md-6 col-lg-5">
                    <div class="bg-white p-4 rounded shadow">
                        <h3 class="text-center text-primary mb-4">Actualizar División</h3>
                        ...
                        <div class="d-grid gap-2">
                            <asp:Button ID="btnActualizar" runat="server" Text="Actualizar División" CssClass="btn btn-success" OnClick="btnActualizar_Click" />
